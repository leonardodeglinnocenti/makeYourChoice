"""
Django settings for makeYourChoice project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'K-9SgD_ZlnSjqj0IwIJ3GuNCz7-e-Gc-aPB3LtBz0eA')
...
ROOT_URLCONF = 'makeYourChoice.urls'
...
WSGI_APPLICATION = 'makeYourChoice.wsgi.application'
